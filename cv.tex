...
\begin{rSubsection}{Controlled text generation with attention}{January 2018 - Present}{VAE/GAN based models; Bachelor thesis}{}
\item[] \url{https://github.com/stasbel/text-gen}
\end{rSubsection}
