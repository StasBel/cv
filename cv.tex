...
\item[] JetBrains Research, Kuralenok I.
\end{rSubsection}
...
\item[] JetBrains Research, Shpilman A. | \url{https://github.com/StasBel/prophet-test}
\end{rSubsection}
...
\item[] JetBrains Research, Shpilman A. | \url{https://github.com/StasBel/program-synthesis}
\end{rSubsection}
